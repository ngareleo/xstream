...
For ffmpeg/VAAPI/OMDb/dev-server-port triage, delegate to the `devops` subagent — it owns those playbooks and scans `.github/workflows/` and `scripts/` before answering.
