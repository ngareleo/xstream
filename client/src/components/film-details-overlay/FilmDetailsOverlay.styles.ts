...
export const useFilmDetailsOverlayStyles = makeStyles({
  ...
  openProfileCta: {
    ...
    ":hover": {
      color: tokens.colorGreen,
      backgroundColor: "oklch(0.78 0.20 150 / 0.10)",
      borderTopColor: "oklch(0.78 0.20 150 / 0.35)",
      borderRightColor: "oklch(0.78 0.20 150 / 0.35)",
      borderBottomColor: "oklch(0.78 0.20 150 / 0.35)",
      borderLeftColor: "oklch(0.78 0.20 150 / 0.35)",
    },
