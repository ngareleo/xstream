...
export const usePlayerStyles = makeStyles({
  ...
  // Video area — fills the shell (no longer a grid child)
  videoArea: {
    position: "absolute",
    top: 0,
    right: 0,
  ...
  topbarBtn: {
    ...
    ":hover": {
      color: "#fff",
      filter:
        "drop-shadow(0 0 12px rgba(255,255,255,0.65)) drop-shadow(0 2px 6px rgba(0,0,0,0.6))",
    },
    ":active": {
  ...
  // Drawer scrim — captures clicks outside the open SidePanel to close it
  panelScrim: {
    position: "absolute",
    top: 0,
    left: 0,
  ...
  // Side panel — overlays the video; slides in from the right
  sidePanel: {
    position: "absolute",
    top: 0,
    right: 0,
  ...
  // Close button (top-right of the open panel)
  panelCloseBtn: {
    position: "absolute",
    top: "12px",
    right: "12px",
