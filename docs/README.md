...
- [`client/`](client/README.md) — Topics scoped to the React client: per-component design specs (Components/), Feature-Flags, Debugging-Playbooks, Config, Bundle-Chunks.
- [`server/`](server/README.md) — Topics scoped to the Rust server: Config, GraphQL-Schema, DB-Schema, Hardware-Acceleration.
- [`design/`](design/README.md) — UI design spec: tokens, type, spacing, behavioural contracts.
- [`release/`](release/README.md) — Outstanding redesign work (working document, post-migration).
