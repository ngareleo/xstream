...
_Last regenerated: 2026-04-27 (updated for FIRST_CHUNK_DURATION_S + parallel init/mutation boot). Owned by the `architect` subagent; regenerated mechanically by the `groom-knowledge-base` skill._
