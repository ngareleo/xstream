...
_Last regenerated: 2026-04-27 (PR #35 — VAAPI HDR startS=0 cold-start workaround). Owned by the `architect` subagent; regenerated mechanically by the `groom-knowledge-base` skill._
