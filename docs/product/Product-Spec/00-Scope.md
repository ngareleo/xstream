...
All in all, that's how I get majority of my movies, but I'd like to improve this a bit. For starters, I'd like a nice site where I can browse my catalog and choose what to watch in one place. The app — Xstream — covers exactly that: a clean local-first catalog browser plus a player that streams those files to whichever device I'm on.
